...
;
const metadata = {
    title: 'The Human Heart — Interactive Anatomy',
    description: 'Explore the human heart with interactive blood flow animations and anatomical details. Learn about chambers, valves, and the circulatory system.'
};
const viewport = {
    width: 'device-width',
    initialScale: 1
